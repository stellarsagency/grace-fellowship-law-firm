(function(){
  ...
  css.textContent='#chatWidget{position:fixed;bottom:24px;right:24px;z-index:9999;font-family:"Source Sans 3",sans-serif}'
    ...
    +'.cb-contact-btn.cb-wa{background:#25D366}'
    +'.cb-contact-btn.cb-wa:hover{background:#1ebe5a}'
    +'.cb-contact-btn.cb-email{background:#1A312C}'
    +'.cb-contact-btn.cb-email:hover{background:#2f4a43}'
