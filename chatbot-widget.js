(function(){
  ...
  css.textContent='#chatWidget{position:fixed;bottom:24px;right:24px;z-index:9999;font-family:"Source Sans 3",sans-serif}'
    +'#chatFab{width:68px;height:68px;border-radius:50%;background:linear-gradient(135deg,#8B5E3C,#a8764f);color:#fff;border:none;font-size:1.8rem;cursor:pointer;box-shadow:0 6px 24px rgba(139,94,60,.4);transition:all .3s;display:flex;align-items:center;justify-content:center}'
    ...
    +'.cb-head{background:linear-gradient(135deg,#061a30,#0A2947);padding:14px 16px;display:flex;align-items:center;gap:12px;flex-shrink:0}'
    +'.cb-head img{width:36px;height:36px;border-radius:50%;border:2px solid #8B5E3C}'
    +'.cb-head-text h4{font-family:"Playfair Display",serif;color:#fff;font-size:.92rem;margin:0}'
    +'.cb-head-text span{font-size:.7rem;color:#a8764f;display:flex;align-items:center;gap:4px}'
    ...
    +'.cb-user{background:#0A2947;color:#fff;align-self:flex-end;border-bottom-right-radius:2px}'
    +'.cb-bot strong{color:#0A2947;display:block;margin-bottom:3px;font-size:.82rem}'
    +'.cb-bot a{color:#8B5E3C;font-weight:700;text-decoration:underline}'
    +'.cb-qr{display:flex;flex-wrap:wrap;gap:6px;padding:0 14px 10px;flex-shrink:0}'
    +'.cb-qr-btn{padding:6px 14px;border:1.5px solid #8B5E3C;border-radius:999px;background:transparent;color:#0A2947;font-size:.78rem;font-weight:600;cursor:pointer;transition:all .3s;font-family:inherit}'
    +'.cb-qr-btn:hover{background:#8B5E3C;color:#fff}'
    ...
    +'.cb-input input:focus{border-color:#8B5E3C}'
    +'.cb-input button{width:44px;height:44px;border-radius:50%;background:#8B5E3C;color:#fff;border:none;font-size:1.2rem;cursor:pointer;transition:all .3s;flex-shrink:0;display:flex;align-items:center;justify-content:center}'
    +'.cb-input button:hover{background:#0A2947;color:#fff}'
    +'.cb-typing{display:flex;gap:4px;padding:10px 14px;align-self:flex-start}'
    +'.cb-typing span{width:7px;height:7px;background:#8B5E3C;border-radius:50%;animation:cbTyp 1.4s infinite}'
