(function(){
  ...
  css.textContent='#chatWidget{position:fixed;bottom:24px;right:24px;z-index:9999;font-family:"Source Sans 3",sans-serif}'
    +'#chatFab{width:68px;height:68px;border-radius:50%;background:linear-gradient(135deg,#c9a84c,#b8942e);color:#1f1604;border:none;font-size:1.8rem;cursor:pointer;box-shadow:0 6px 24px rgba(201,168,76,.4);transition:all .3s;display:flex;align-items:center;justify-content:center}'
    ...
    +'.cb-head{background:linear-gradient(135deg,#1f1604,#2e2006);padding:14px 16px;display:flex;align-items:center;gap:12px;flex-shrink:0}'
    ...
    +'.cb-user{background:#3B2A07;color:#fff;align-self:flex-end;border-bottom-right-radius:2px}'
    +'.cb-bot strong{color:#3B2A07;display:block;margin-bottom:3px;font-size:.82rem}'
    +'.cb-bot a{color:#3B2A07;font-weight:700;text-decoration:underline}'
    +'.cb-qr{display:flex;flex-wrap:wrap;gap:6px;padding:0 14px 10px;flex-shrink:0}'
    +'.cb-qr-btn{padding:6px 14px;border:1.5px solid #c9a84c;border-radius:999px;background:transparent;color:#3B2A07;font-size:.78rem;font-weight:600;cursor:pointer;transition:all .3s;font-family:inherit}'
    +'.cb-qr-btn:hover{background:#c9a84c;color:#1f1604}'
    ...
    +'.cb-input button{width:44px;height:44px;border-radius:50%;background:#c9a84c;color:#1f1604;border:none;font-size:1.2rem;cursor:pointer;transition:all .3s;flex-shrink:0;display:flex;align-items:center;justify-content:center}'
    +'.cb-input button:hover{background:#3B2A07;color:#fff}'
