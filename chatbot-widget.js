(function(){
  ...
  css.textContent='#chatWidget{position:fixed;bottom:24px;right:24px;z-index:9999;font-family:"Source Sans 3",sans-serif}'
    +'#chatFab{width:68px;height:68px;border-radius:50%;background:linear-gradient(135deg,#EC5B38,#f4755a);color:#fff;border:none;font-size:1.8rem;cursor:pointer;box-shadow:0 6px 24px rgba(236,91,56,.4);transition:all .3s;display:flex;align-items:center;justify-content:center}'
    ...
    +'.cb-head{background:linear-gradient(135deg,#332c2c,#524646);padding:14px 16px;display:flex;align-items:center;gap:12px;flex-shrink:0}'
    +'.cb-head img{width:36px;height:36px;border-radius:50%;border:2px solid #EC5B38}'
    +'.cb-head-text h4{font-family:"Playfair Display",serif;color:#fff;font-size:.92rem;margin:0}'
    +'.cb-head-text span{font-size:.7rem;color:#f4755a;display:flex;align-items:center;gap:4px}'
    ...
    +'.cb-user{background:#524646;color:#fff;align-self:flex-end;border-bottom-right-radius:2px}'
    +'.cb-bot strong{color:#524646;display:block;margin-bottom:3px;font-size:.82rem}'
    +'.cb-bot a{color:#EC5B38;font-weight:700;text-decoration:underline}'
    +'.cb-qr{display:flex;flex-wrap:wrap;gap:6px;padding:0 14px 10px;flex-shrink:0}'
    +'.cb-qr-btn{padding:6px 14px;border:1.5px solid #EC5B38;border-radius:999px;background:transparent;color:#524646;font-size:.78rem;font-weight:600;cursor:pointer;transition:all .3s;font-family:inherit}'
    +'.cb-qr-btn:hover{background:#EC5B38;color:#fff}'
    ...
    +'.cb-input input:focus{border-color:#EC5B38}'
    +'.cb-input button{width:44px;height:44px;border-radius:50%;background:#EC5B38;color:#fff;border:none;font-size:1.2rem;cursor:pointer;transition:all .3s;flex-shrink:0;display:flex;align-items:center;justify-content:center}'
    +'.cb-input button:hover{background:#524646;color:#fff}'
    +'.cb-typing{display:flex;gap:4px;padding:10px 14px;align-self:flex-start}'
    +'.cb-typing span{width:7px;height:7px;background:#EC5B38;border-radius:50%;animation:cbTyp 1.4s infinite}'
